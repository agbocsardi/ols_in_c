...
I have encountered the differences between `*` and `&` pointers! I have been digging into the rabbithole a bit, my garbage collected pythonista brain has a somewhat hard time interpreting it, despite undestanding it. I guess a large part of the whole "manual memory management" game is about developing the eye and frame of thinking for this. 
